...
void loop()
{
 ...
 { 
  ...
  analogWrite(led5, 20);    // posar PWM del pin 11 a 125
  
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
  
  analogWrite(led0, 0);    // posar PWM del pin 3 a 255
  analogWrite(led1, 0);    // posar PWM del pin 5 a 255
  analogWrite(led2, 255);    // posar PWM del pin 6 a 255
  analogWrite(led3, 127);    // posar PWM del pin 9 a 255
  analogWrite(led4, 20);    // posar PWM del pin 10 a 255
  ...
  analogWrite(led3, 20);    // posar PWM del pin 9 a 125
  ...
  analogWrite(led2, 20);     // posar PWM del pin 6 a 60
  analogWrite(led3, 0);     // posar PWM del pin 9 a 60
  ...
  analogWrite(led0, 127);    // posar PWM del pin 3 a 125
  analogWrite(led1, 20);    // posar PWM del pin 5 a 125
  analogWrite(led2, 0);    // posar PWM del pin 6 a 125
  ...
  analogWrite(led0, 20);    // posar PWM del pin 3 a 125
  analogWrite(led1, 0);    // posar PWM del pin 5 a 125
  analogWrite(led2, 0);    // posar PWM del pin 6 a 125
  analogWrite(led3, 0);    // posar PWM del pin 9 a 125
  analogWrite(led4, 0);    // posar PWM del pin 10 a 125
  ...
  analogWrite(led0, 20);    // posar PWM del pin 3 a 125
  analogWrite(led1, 127);    // posar PWM del pin 5 a 125
  ...
  analogWrite(led0, 0);    // posar PWM del pin 3 a 125
  analogWrite(led1, 0);    // posar PWM del pin 5 a 125
  analogWrite(led2, 20);    // posar PWM del pin 6 a 125
  ...
  analogWrite(led2, 0);    // posar PWM del pin 6 a 125
  analogWrite(led3, 0);    // posar PWM del pin 9 a 125
  analogWrite(led4, 20);    // posar PWM del pin 10 a 125
  ...
  analogWrite(led3, 0);    // posar PWM del pin 9 a 125
  analogWrite(led4, 0);    // posar PWM del pin 10 a 125
  analogWrite(led5, 20);    // posar PWM del pin 11 a 125 delay (velocitat);
